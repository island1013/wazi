...
class exchangeAction extends frontendAction {
    ...
    public function detail() {
        ...
        !$id && $this->redirect('exchange/index');
    ...
    public function ec() {
        ...
        if (!$id || !$num) $this->ajaxReturn(0, '请选择需要兑换的商品！');
        $item_mod = M('score_item');
        $user_mod = M('user');
