    ...
    $.pinphp.setting = {
        ...
        basic: function(){
            ...
            $('#J_upload_avatar').uploader({
                action_url: '?m=user&a=upload_avatar',
                input_name: 'avatar',
        ...
        cover: function(){
            $('#upload_cover').uploader({
                action_url: '?m=user&a=upload_cover',
                input_name: 'cover',
            ...
            $('#J_cancle_cover').live('click', function(){
                $.getJSON('?m=user&a=cancle_cover', function(result){
                    if(result.status == '1'){
        ...
        message_list: function(){
            ...
            $('#J_msg_list').find('.J_ml_del').live('click', function(){
                ...
                $.getJSON('?m=message&a=del', {mid:mid}, function(result){
                    if (result.status == '1') {
