    ...
    $.pinphp.user = {
        ...
        follow: function(){
            ...
            $(s.follow_bar).find('.J_fo_u').live('click', function(){
                ...
                $.getJSON('?m=user&a=follow', {uid:uid}, function(result){
                    if(result.status == 1){
        ...
        unfollow: function(){
            ...
            $(s.follow_bar).find('.J_unfo_u').live('click', function(){
                ...
                var self = $(this),
                    uid = $(this).parent().attr('data-uid');
                $.getJSON('?m=user&a=unfollow', {uid:uid}, function(result){
                    if(result.status == 1){
                ...
                mouseover: function(){
                    ...
                    if($('body').data(uid) != void(0) && $('body').data(uid) != ''){
                        ...
                        n = setTimeout(function(){
                            $.getJSON('?m=space&a=card', {uid:uid}, function(result){
                                if(result.status == 1){
